...
async function activate(context) {
    ...
    if (os.platform() === 'darwin') {
        ...
        const namespace = sdk.integration._namespace;
        ...
        sdk.integration._integrity._workbenchDir = correctDir;
        if (sdk.integration._titles) {
            sdk.integration._titles._workbenchDir = correctDir;
        }
    }
...
`;
    ...
    await sdk.integration.installSeamless((cmd) => vscode.commands.executeCommand(cmd), (msg, ...items) => vscode.window.showInformationMessage(msg, ...items));
